...
public class FortyFiveMileMap extends SimpleMap implements TextToSpeech.OnInitListener {
    ...
    private int route = 4; //getRouteID from activity file.
    private int step = 1;
    private int count = 0;
    private String lat;
    private String lon;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setupMapView();
        setupMyLocation();
        getter = new DataRetriever(FortyFiveMileMap.this);
        firstPoints = setPoints(0, 40);
        restPoints = setPoints(40, getter.getNumSteps(route));
        ...
        myLocationManager = (LocationManager) getSystemService(FortyFiveMileMap.this.LOCATION_SERVICE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.aboutScreen:
                Intent intent = new Intent(FortyFiveMileMap.this, About_Screen.class);
